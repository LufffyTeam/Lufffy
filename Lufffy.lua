...
io.popen("cd library && wget https://raw.githubusercontent.com/LufffyTeam/Lufffy/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LufffyTeam/Files_Lufffy/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevLufffyW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevLufffyW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevLufffyW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLufffyW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevLufffyW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevLufffyW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevLufffyW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local Lufffy_Msg = ''  
if msgs < 100 then 
Lufffy_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Lufffy_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Lufffy_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Lufffy_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Lufffy_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Lufffy_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Lufffy_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Lufffy_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Lufffy_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Lufffy_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Lufffy_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Lufffy_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Lufffy_Msg = 'رب التفاعل'  
end 
return Lufffy_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@lllEll1")  
...
--------------------------------------------------------------------------------------------------------------
function SourceLufffy(msg,data) -- بداية العمل ليث الـ عـبـيد
if msg then
...
local list = database:smembers(bot_id.."Lufffy1:List:Filter"..sl)
...
if not DevLufffyW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevLufffyW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Lufffy_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✬' and DevLufffyW(msg) then  
...
if text == 'تعطيل التواصل ✬' and DevLufffyW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✬' and DevLufffyW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✬' and DevLufffyW(msg) then  
...
if text == 'ضع كليشه ستارت ✬' and DevLufffyW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✬︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✬' and DevLufffyW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✬' and DevLufffyW(msg) then 
...
if text == 'تحديث السورس ✬' and DevLufffyW(msg) then 
os.execute('rm -rf Lufffy.lua')
os.execute('wget https://raw.githubusercontent.com/LufffyTeam/Lufffy/main/Lufffy.lua')
send(msg.chat_id_, msg.id_,' *✬︙تم تحديث السورس* \n*✬︙لديك اخر اصدار لسورس لوفي*\n*✬︙الاصدار » { 2.8v}*')
dofile('Lufffy.lua')  
end
if text == 'الاصدار ✬' and DevLufffyW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙اصدار سورس لوفي* \n*✬︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✬' and DevLufffyW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✬︙[تحديثات البوت](t.me/lllEll4) \n✬︙[قناه السورس](t.me/lllEll2)')
end
if text == "ضع اسم للبوت ✬" and DevLufffyW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✬' and DevLufffyW(msg) then 
...
if text == 'المشتركين ✬' and DevLufffyW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✬' and DevLufffyW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✬") and DevLufffyW(msg) then
...
if text == ("قائمه العام ✬") and DevLufffyW(msg) then
...
if text == ("قائمه الكتم العام ✬") and DevLufffyW(msg) then
...
if text=="اذاعه خاص ✬" and msg.reply_to_message_id_ == 0 and DevLufffyW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✬" and msg.reply_to_message_id_ == 0 and DevLufffyW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✬" and msg.reply_to_message_id_ == 0 and DevLufffyW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✬" and msg.reply_to_message_id_ == 0  and DevLufffyW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✬" and msg.reply_to_message_id_ == 0  and DevLufffyW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✬︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✬' and DevLufffyW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✬" and DevLufffyW(msg) then
...
if text == "تنظيف الكروبات ✬" and DevLufffyW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✬︙عدد الكروبات الان » { '..#group..' }'..Lufffyk..''..Lufffy..'*\n*✬︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevLufffyW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevLufffyW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevLufffyW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevLufffyW(msg) then
...
local Lufffy1_Msg = database:get(bot_id.."Lufffy1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Lufffy1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if Lufffy_Msg and not Special(msg) then  
local Lufffy_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Lufffy_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevLufffyW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevLufffyW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevLufffyW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevLufffyW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✬" and DevLufffyW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✬︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✬$") and DevLufffyW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✬" and DevLufffyW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✬" and DevLufffyW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✬︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✬" and DevLufffyW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."Lufffy:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Lufffy:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Lufffy = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Lufffy then 
names_Lufffy = database:smembers(bot_id.."Lufffy:blocname"..msg.chat_id_) or ""
if names_Lufffy and names_Lufffy[1] then 
for i=1,#names_Lufffy do 
if name_Lufffy:match("(.*)("..names_Lufffy[i]..")(.*)") then 
...
database:set(bot_id.."Lufffy:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Lufffy:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Lufffy:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Lufffy:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Lufffy:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Lufffya_new(Lufffy1,Lufffy2)
if Lufffy2 and Lufffy2.first_name_ then 
if Lufffy2.first_name_:match("(.*)"..database:get(bot_id.."Lufffy:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Lufffy:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Lufffy_nnn = database:get(bot_id.."Lufffy:nump"..msg.chat_id_) or 5
local Lufffy_nnn2 = database:get(bot_id.."Lufffy:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Lufffy_nnn2) == tonumber(Lufffy_nnn) or tonumber(Lufffy_nnn2) > tonumber(Lufffy_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Lufffy:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✬︙عزيزي >>["..Lufffy2.username_.."](https://t.me/"..(Lufffy2.username_ or "lllEll2")..")\n✬︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Lufffy:teh"..msg.chat_id_).."} بجانب اسمك\n✬︙عدد المحاولات المتبقيه {"..(tonumber(Lufffy_nnn) - tonumber(Lufffy_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Lufffya_new)
end
end
...
local LufffyChengName = database:get(bot_id.."Lufffy:Cheng:Name"..data.id_)
if not data.first_name_ then 
if LufffyChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..LufffyChengName..']')
database:del(bot_id.."Lufffy:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if LufffyChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Lufffy:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local LufffyChengUserName = database:get(bot_id.."Lufffy:Cheng:UserName"..data.id_)
if not data.username_ then 
if LufffyChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..LufffyChengUserName..']')
database:del(bot_id.."Lufffy:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if LufffyChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Lufffy:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local LufffyChengPhoto = database:get(bot_id.."Lufffy:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if LufffyChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Lufffy:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if LufffyChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Lufffy:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʟᴜғғʏ\n\n[✬  ʟᴜғғʏ ᴄʜᴀɴɴᴇʟ](http://t.me/lllEll2)\n\n[✬  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/lllEll4)\n\n[✬  ʟᴜғғʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/lllEll1)\n\n[✬  ʙᴏᴛ ʟᴜғғʏ](http://t.me/lllEll22bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✬ sᴏᴜʀᴄʀ ʟᴜғғʏ',url="t.me/lllEll2"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع نسخه الاحتياطيه' and DevLufffyW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
if text == "ترتيب الاوامر" and Constructor(msg) then
 ...
 database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
 database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
------------------------------------------------------------------------ ليث الـ عـبـيد
if text == 'تحديث' and DevLufffyW(msg) then
dofile('Lufffy.lua')  
send(msg.chat_id_, msg.id_, ' *✬︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevLufffyW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevLufffyW(msg) then  
function start_function(extra, result, success)
if LufffySudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevLufffyW(msg) then  
...
if LufffySudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevLufffyW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if LufffySudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevLufffyW(msg) then  
function start_function(extra, result, success)
if LufffySudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevLufffyW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevLufffyW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if LufffySudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevLufffyW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevLufffyW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevLufffyW(msg) then  
...
------------------------------------------------------------------------ ليث الـ عـبـيد
if text == ("مسح المطورين") and DevLufffyW(msg) then
...
if text == 'الملفات' and DevLufffyW(msg) then
t = ' *✬︙ملفات السورس لوفي ↓*\n*•━━━━━━ 𝐋𝐅𝐘 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevLufffyW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LufffyTeam/Files_Lufffy/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevLufffyW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LufffyTeam/Files_Lufffy/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevLufffyW(msg) then
...
if text == "مسح الملفات" and DevLufffyW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✬︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevLufffyW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevLufffyW(msg) then  
function start_function(extra, result, success)
...
function Function_Lufffy(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Lufffy, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Lufffy, nil)
return false 
end
...
database:set(bot_id.."Lufffy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Lufffy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✬︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Lufffy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Lufffy1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Lufffy1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Lufffy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✬︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Lufffy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Lufffy1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Lufffy1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Lufffy1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✬︙ارسل الكلمه الان*")  
database:set(bot_id.."Lufffy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Lufffy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Lufffy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Lufffy1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Lufffy1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Lufffy1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Lufffy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Lufffy1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Lufffy1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevLufffyW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✬︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevLufffyW(msg) then
...
if text == 'تفعيل الاذاعه' and DevLufffyW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevLufffyW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Lufffy_Msg[math.random(#Lufffy_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevLufffyW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,Lufffy)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝐋𝐅𝐘 ━━━━━━━•*\n"
x = 0
local list = Lufffy.members_
for k, v in pairs(list) do
x = x + 1
...
if LufffySudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevLufffyW(msg) then 
...
if text == ("ردود المطور") and DevLufffyW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✬︙قائمة ردود المطور \n*•━━━━━━ 𝐋𝐅𝐘 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevLufffyW(msg) then    
send(msg.chat_id_, msg.id_,' *✬︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevLufffyW(msg) then    
...
if text == 'تفعيل المغادره' and DevLufffyW(msg) then   
...
if text == 'تعطيل المغادره' and DevLufffyW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✬︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll4')..') '
...
-- vardump(data) 
Lufffydx(msg.chat_id_, msg.id_, ' *✬︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✬︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✬︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✬︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevLufffyW(msg) then
...
{{text = '.⌁︙LUFFY TEAM', url="t.me/lllEll4"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ✬∫ٴ*•━━━━━━ 𝐋𝐅𝐘 ━━━━━━━•*ٴ✬∫○ٴ\n✬︙[.⌁︙LUFFY TEAM](t.me/lllEll2) ')
end
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʟᴜғғʏ',url='http://t.me/lllEll4'}},
}
...
Lufffy = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Lufffy)
...
--------------------------------------------------------------------------------------------------------------
SourceLufffy(data.message_,data)
...
------------------------------------------------------------------------
local LufffyAbot = database:get(bot_id.."Lufffy1:Add:Filter:Rp2"..text..result.chat_id_)   
if LufffyAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..LufffyAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Lufffy1_Msg = database:get(bot_id.."Lufffy1:Add:Filter:Rp2"..text..result.chat_id_)   
if Lufffy1_Msg then
send(msg.chat_id_, msg.id_," ✬︙"..Lufffy1_Msg)
