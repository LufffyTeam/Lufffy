...
local RunBot = io.open("Lufffy", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/Lufffy
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr Lufffy.lua
wget "https://raw.githubusercontent.com/LufffyTeam/Lufffy/main/Lufffy.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./Lufffy.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S Lufffy -X kill
screen -S Lufffy ./Lufffy
done
]])
RunTs:close()
end
